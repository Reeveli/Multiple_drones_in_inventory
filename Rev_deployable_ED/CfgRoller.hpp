class Item_Rev_Roller: Item_ToolKit
{
	author = "Reeveli";
	displayName = "Deployable ED-1E Roller";
...
class B_Rev_Roller: B_UGV_02_Science_F
{		
	author = "Reeveli";
	displayname = "Deployable ED-1E Roller";
	class assembleInfo
	...
	class UserActions
	{
		...
		class pick_up
		{
			...
			statement = "[this,'Item_Rev_Roller'] call Rev_uav_fnc_pick_up";
			position = "";
			priority = 5;
			radius = 1.8;
			animPeriod = 2;
...
class O_Rev_Roller: O_UGV_02_Science_F
{
	
	author = "Reeveli";
	displayname = "Deployable ED-1D Sayyah";
	class assembleInfo
	{
		primary = 0;
		base = "";
...
class I_Rev_Roller: I_UGV_02_Science_F
{
	author = "Reeveli";
	displayname = "Deployable ED-1E Roller";
	class assembleInfo
...
class C_Rev_Roller: I_UGV_02_Science_F
{
	author = "Reeveli";
	displayname = "Deployable ED-1E Roller";
	faction = "CIV_IDAP_F";
